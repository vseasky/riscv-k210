...
#define LCD_DIRECTION DIR_YX_RLDU
#define LCD_INVERSION INVERSION_DISPALY_ON
...
void lcd_init(void)
{
    ...
    lcd_set_direction(LCD_DIRECTION);
    usleep(10 * 1000);
    tft_write_command(LCD_INVERSION);
...
{
#if LCD_INVERSION == INVERSION_DISPALY_ON
    color = ~color;
#endif
